module.exports = {
    ...
    NOTITY_LOGIN: "Sai mật khẩu, bạn còn %d lần đăng nhập",
    ...
    ERROR_EXISTS: "%s này đã tồn tại",
    NOTIFY_LOGIN_AGAIN: "Vui lòng đăng nhập lại sau %d phút",
    ...
    SUCCESS_DELETE_LISTFRIENDS: "Xóa thành công bạn bè có id: %s",
    SUCCESS_UPDATE_LISTFRIENDS: "Cập nhật thành công bạn bè có id: %s",
    ...
    SUCCESS_DELETE_MATCHES: "Xóa thành công phòng chơi có id: %s",
